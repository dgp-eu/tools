...
public final class BasicStructuresClass {
    ...
    public static int convertStringIntoInteger(final String strNumber) {
        ...
        if (isNumeric) {
            try {
                ...
                final String strFeedback = String.format(ConfigurationClass.CONVERT_INT_NA, strNumber,
                        Arrays.toString(noFormatException.getStackTrace()));
                LogExposureClass.LOGGER.error(strFeedback);
            }
        }
    ...
    public static final class NumberConversionSubClass {
        ...
        public static String convertUnits(final long inBytes, final String strStyle) {
            String outString = "";
            final List<String> knownStyles = Arrays.asList(ConfigurationClass.STR_BINARY, ConfigurationClass.STR_DECIMAL);
            if (knownStyles.contains(strStyle)) {
                long[] arrayNumbers = {1L};
                String[] arraySymbols = {"byte"};
                if (ConfigurationClass.STR_DECIMAL.equalsIgnoreCase(strStyle)) {
                    arrayNumbers = ARRAY_DEC_NO;
                    arraySymbols = ARRAY_DEC_UNITS;
                } else if (ConfigurationClass.STR_BINARY.equalsIgnoreCase(strStyle)) {
    ...
    public static final class StringConversionSubClass {
        ...
        private static String convertPromptParameters(final String strOriginalQ, final String type) {
            ...
            } else if (ConfigurationClass.STR_NAMED_PARAM.equalsIgnoreCase(type)) {
                for (final String currentPrmtName : listMatches) {
        ...
        public static String convertPromptParametersIntoNamedParameters(final String strOriginalQ) {
            return convertPromptParameters(strOriginalQ, ConfigurationClass.STR_NAMED_PARAM);
        }
    ...
    public static final class StringEvaluationSubClass {
        ...
        public static boolean isStringActuallyDecimal(final String inputString) {
            return RegularExpressionsClass.ValidationSubClass.isStringActuallySomething(inputString, ConfigurationClass.STR_DECIMAL);
        }
        ...
        public static boolean isStringActuallyInteger(final String inputString) {
            ...
            if (evaluation
                ...
                try {
                    ...
                    final String strFeedback = String.format(ConfigurationClass.CONVERT_INT_NA, inputString, Arrays.toString(noFormatException.getStackTrace()));
                    LogExposureClass.LOGGER.error(strFeedback);
                    evaluation = false;
                }
            }
        ...
        public static boolean isStringActuallyLongTimestampWithMilliseconds(final String inputString) {
            return RegularExpressionsClass.ValidationSubClass.isStringActuallySomething(inputString,
                    RegularExpressionsClass.REGEXP_LONG_TS_MS);
        }
        ...
        public static boolean isStringActuallyTimestamp(final String inputString) {
            return RegularExpressionsClass.ValidationSubClass.isStringActuallySomething(inputString, ConfigurationClass.STR_TIMESTAMP);
        }
        ...
        public static boolean isStringActuallyTimestampWithMilliseconds(final String inputString) {
            return RegularExpressionsClass.ValidationSubClass.isStringActuallySomething(inputString, ConfigurationClass.STR_TS_MSEC);
        }
